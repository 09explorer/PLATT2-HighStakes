...
def goalRush(robotData):
    ...
    basicMove.toPoint(robotData, (135, 6), linVel=20, duration=2)

    basicMove.toPoint(robotData, (130, 12), linVel=20, duration=2, reverse=True)

    basicMove.toHeading(robotData, 300)

    basicMove.toPoint(robotData, (135, 6), linVel=20, duration=2)

    basicMove.toPoint(robotData, (120, 22), linVel=20, duration=2, reverse=True)
