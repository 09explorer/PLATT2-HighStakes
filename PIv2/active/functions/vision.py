...
class vision:
    ...
    def chase(self, robotData, wantedColor, kpLin = 20):
        ...
        while target is not None and abs(target[1]) > 10:
            ...
            robotData[label.LEFTVEL.value]  = -target[1]*0.3
            robotData[label.RIGHTVEL.value] =  target[1]*0.3
        ...
        while target is not None:
            ...
            robotData[label.LEFTVEL.value]  = kpLin - target[1]*0.1
            robotData[label.RIGHTVEL.value] = kpLin + target[1]*0.1
    ...
    def getGoal(self, robotData, kpLin = 20):
        ...
        while target is not None and abs(target[1]) > 10:
            ...
            robotData[label.LEFTVEL.value] =   target[1]*0.1
            robotData[label.RIGHTVEL.value] = -target[1]*0.1
        ...
        while (target is not None) and (abs(target[0]) > 500):
            ...
            robotData[label.LEFTVEL.value]  = kpLin + target[1]*0.2
            robotData[label.RIGHTVEL.value] = kpLin - target[1]*0.2
        ...
        robotData[label.LEFTVEL.value]  = -15
        robotData[label.RIGHTVEL.value] = -15
